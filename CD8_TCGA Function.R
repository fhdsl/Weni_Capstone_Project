CD8Expr_Comparison = function(genename){row_info <- as.data.frame(rowData(data_se))
...
combined_boxplots <- map(GeneNames, CD8Expr_Comparison)


destination = "C:\\Users\\weniw\\Downloads\\combined_boxplots.pdf"
